...
function EditBranch({ branchInfo }: { branchInfo: branch }) {
  ...
  const validateInfo = () => {
    ...
    return (
      validateName &&
      validateLaunchDate &&
      (branchInfo.branch_name !== info.branch_name ||
        branchInfo.mgr_id !== info.mgr_id ||
        branchInfo.start_day !== info.start_day)
    );
  };
  ...
  const deleteBranch = async () => {
    try {
      axios.delete(`${host}/branch/delete`, {
        data: {
          branchID: info.branch_id,
        },
      });
              ...
              <tr>
                ...
                <td className="py-2">
                  <input
                    ...
                    defaultValue={branchInfo.branch_name}
                    onChange={(e) =>
              ...
              <tr>
                ...
                <td className="py-2">
                  <select
                    ...
                    className="bg-gray-200 py-2 px-4 rounded-md"
                    onChange={(e) =>
                      setInfo({ ...info, mgr_id: +e.target.value })
                    }
                  >
              ...
              <tr>
                <td className="py-2">
                  <label
                    htmlFor="startDate"
                    className={`text-[18px] mr-4 ${
                      !validation.launchDate && 'text-red-600'
                    }`}
                  >
                    launch date
                  </label>
                ...
                <td className="py-2">
                  <input
                    ...
                    className="bg-gray-200 py-2 px-4 rounded-md"
                    onChange={(e) =>
                      setInfo({ ...info, start_day: e.target.value })
                    }
