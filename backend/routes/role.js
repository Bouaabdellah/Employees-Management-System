...
role.get('/roleList',handlJWT,handlRoles(requirementRoles.role_id),(req,res) => {
    return res.status(200).json({message : 'get all roles with sucess',rolesList : rolesList});
});
