...
function EditeProfile({employee} : {employee : employee}){
  ...
  try {
    ...
    await axios.put(`http://localhost:${port}/employees/modify`,formData);  
  } catch (error) {
    console.log(error);
  } 
  }
  ...
  return (
    <div className="w-fit mx-auto mt-8">
       ...
       {edit && 
       <form onSubmit={(e) => e.preventDefault()} method="PUT" encType="multipart/form-data"
      ...
      <button className="py-2 px-4 capitalize bg-green-700 mr-6 rounded-md text-white
        duration-300 hover:bg-green-800" type="submit" onClick={() => putData()}>
        save
      </button>
