...
function Footer() {
  ...
  return (
    <div className="bg-black absolute left-0 bottom-0 w-full pt-10">
    <Container>
    <div>
    <div className="text-white text-2xl font-semibold text-center mb-10">
    ...
    <div className="text-white text-[18px] w-[300px] mt-6">
    Don 't hesitate to contact us if you have any question, or problem
    </div>
    </div>
    <div className="flex flex-col gap-6">
    <div className="flex gap-6 items-center">
    <span className="text-2xl text-green-400"><FaLocationDot/></span>
    ...
    <div className="flex gap-6 items-center">
    <span className="text-2xl text-green-400"><FaClock/></span>
    <div className="flex flex-col gap-2">
    ...
    <div className="flex gap-6 items-center">
    <span className="text-2xl text-green-400"><FaPhoneVolume/></span>
    <div className="flex flex-col gap-2">
