...
function SearchEmployees() {
  ...
  return (
    <div className="mb-6">
      ...
      <input type="text" placeholder="firstname..." className="bg-gray-200 py-2 px-4 rounded-md" id="firstname"
      onChange={(e) => setInfo({...info, firstname : e.target.value})}/>
      </div>
      <div className="flex flex-col gap-2">
      <label htmlFor="lastname">lastname</label>
      <input type="text" placeholder="lastname..." className="bg-gray-200 py-2 px-4 rounded-md" id="lastname"
      onChange={(e) => setInfo({...info, lastname : e.target.value})}/>
      </div>
      <div className="flex flex-col gap-2">
      <label htmlFor="id">id</label>
      <input type="number" placeholder="id..." className="bg-gray-200 py-2 px-4 rounded-md" id="id"
      onChange={(e) => setInfo({...info, id : +e.target.value})}/>
      </div>
      <div className="flex flex-col gap-2">
      <label htmlFor="branch" className={`text-[18px] mr-4`}>branch</label>
      <select id="branch" className="bg-gray-200 py-2 px-4 rounded-md"
      onChange={(e) => setInfo({...info,branchID : +e.target.value})}>
